                	...
                	<div class="point-system">
                        ...
                        <ul class="list-point">
                       		<li>
                            	...
                            	<p class="point-text"><i class="fa fa-star"></i><?php _e("story is voted up", ET_DOMAIN) ?></p>
                            </li>
                            <li>
                            	<span class="point-circle">+ <?php echo $badge_points->a_vote_up ? $badge_points->a_vote_up : 0  ?></span>
                            	<p class="point-text"><i class="fa fa-star"></i><?php _e("comment is voted up", ET_DOMAIN) ?></p>
                            </li>
                            <li>
                            	<span class="point-circle">+ <?php echo $badge_points->a_accepted ? $badge_points->a_accepted : 0  ?></span>
                            	<p class="point-text"><i class="fa fa-star"></i><?php _e("comment is accepted", ET_DOMAIN) ?></p>
                            </li>
                            <!-- <li>
                	...
                	<div class="point-system">
						...
						<div class="badges-point-system">
                            ...
                            <span class="role-user-system">
                                <i class="fa fa-<?php echo $pack->qa_badge_point >= $levels->edit_question ? 'check' : 'ban' ?>"></i><?php _e("Edit other people's stories", ET_DOMAIN) ?>
                            </span>

                            <span class="role-user-system">
                                <i class="fa fa-<?php echo $pack->qa_badge_point >= $levels->edit_answer ? 'check' : 'ban' ?>"></i><?php _e("Edit other people's comments", ET_DOMAIN) ?>
                            </span> 

                            <span class="role-user-system">
                                <i class="fa fa-<?php echo $pack->qa_badge_point >= $levels->vote_down ? 'check' : 'ban' ?>"></i><?php _e("Vote down (costs 1 point on comments)", ET_DOMAIN) ?>
                            </span>
