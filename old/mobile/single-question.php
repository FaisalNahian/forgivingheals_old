...
<div class="wrapper-mobile">
                        ...
                        <div class="content-question">
                            ...
                            <div class="info-tag-time">
                            	...
                            	<span class="time-categories">
                                    <?php
                                        ...
                                        printf( __( 'Story shared by %s %s in', ET_DOMAIN ), $author, $et_post_date );
                                    ?>
                            ...
                            <div class="vote-wrapper">
                                ...
                                <a href="javascript:void(0)" class="answer-active-label has-best-answer">
                                    <i class="fa fa-check"></i><?php _e("Commented", ET_DOMAIN) ?>
                                </a>
                                <?php } ?>
                            </div>
                        </div>
    ...
    <section class="label-vote-wrapper">
    	<div class="container">
            <div class="row">
            	<div class="col-md-12">
                    <span><span class="number"><?php echo et_count_answer($question->ID) ?></span> <?php _e("Comments",ET_DOMAIN) ?></span>
    ...
    <section class="post-answers-wrapper">
    	<div class="container">
            <div class="row">
            	<div class="col-md-12">
        			<a href="javascript:void(0)" class="btn-post-answers"><?php _e("Post comment", ET_DOMAIN) ?></a>
                    <form class="form-post-answers" id="insert_answer" action="">
                    	...
                    	<textarea name="post_content" id="post_content" rows="5"  placeholder="<?php _e("Type your comment", ET_DOMAIN) ?>"></textarea>
                        <input type="submit" class="btn-submit" name="submit" id="" value="<?php _e("Post comment", ET_DOMAIN) ?>">
