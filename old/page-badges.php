            ...
            <ul class="points-define">
                    ...
                    <li class="col-md-3">    
                        <div>
                            ...
                            <span class="star">
                                <i class="fa fa-star"></i><br>
                                <?php _e("comment is voted up", ET_DOMAIN) ?>
                            </span>
                        </div>
                    </li> 
                    <li class="col-md-3">    
                        <div>
                            ...
                            <span class="star">
                                <i class="fa fa-star"></i><br>
                                <?php _e("comment is accepted", ET_DOMAIN) ?>
                            </span>
                        </div>
                    </li>                                                    
            </ul>
                ...
                <div class="border">
                    ...
                    <div class="col-md-3">
                        <p>
                            ...
                            <?php _e("Edit other people's comments", ET_DOMAIN) ?>
                        </p>
                        <p>
                            <i class="fa fa-<?php echo $pack->qa_badge_point >= $levels->vote_down ? 'check' : 'ban' ?>"></i>
                            <?php _e("Vote down (costs 1 point on comments)", ET_DOMAIN) ?>
                        </p>                    
                    </div>
                    <div class="col-md-2">
                        <p>
