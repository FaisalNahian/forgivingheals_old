    ...
    <div class="col-md-8 main-content">
        ...
        <div class="row question-filter">
            <div class="col-md-12 sort-questions">
                <ul>
                    <li>
                        <a class="<?php if(!isset($_GET['type'])) echo 'active'; ?>" href="<?php echo get_author_posts_url($user->ID); ?>"><?php _e('Stories',ET_DOMAIN) ?></a>
                    </li>
                    <li>
                        <a class="<?php if(isset($_GET['type']) && $_GET['type'] == "answer") echo 'active'; ?>" href="<?php echo add_query_arg(array('type'=>'answer')); ?>"><?php _e('Comments',ET_DOMAIN) ?></a>
                    </li>
                    <?php if($current_user->ID == $user->ID){ ?>
                    <li>
            ...
            <ul id="main_questions_list">
                <?php
                    ...
                    if($query->have_posts()){
                        ...
                        echo '<h2>'.__('There is no stories yet.', ET_DOMAIN).'</h2>';
                        echo '</li>';
                    }
                    wp_reset_query();
