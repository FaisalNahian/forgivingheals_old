		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="submit_question">
					...
					<input type="text" class="submit-input" id="question_title" name="post_title" placeholder="<?php _e('Your Story',ET_DOMAIN) ?>" />
					...
					<button id="btn_submit_question" class="btn-submit-question"><?php _e('SUBMIT STORY',ET_DOMAIN) ?></button>
					<p class="term-texts">
						<?php qa_tos("question"); ?>
					</p>
				</form>
